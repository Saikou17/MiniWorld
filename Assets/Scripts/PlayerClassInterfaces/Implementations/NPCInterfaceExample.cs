...
{
    public class NPCInterfaceExample : ILife, IAttack
    {
        /*
        ...
        public NPCInterfaceExample()
        {

        }

        public NPCInterfaceExample(string name, string @class, int level = 1, int life = 100)
        {
        ...
        public void Attack()
        {
            Debug.Log($"NPC {_element.ElementData.GetName()} attacks with fists");
        }
    }
}