...
{
    public class BeastInterfaceExample : ILife, IAttack
    {
        /*
        ...
        public BeastInterfaceExample()
        {
            
        }

        public BeastInterfaceExample(string name, string @class, int level = 1, int life = 100)
        {
        ...
        public void Attack()
        {
            Debug.Log($"Beast {_element.ElementData.GetName()} attacks with fangs");
        }
    }
}